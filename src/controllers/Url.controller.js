    ...
    try {
        ...
        if (!isOriginalUrl) {
            ...
            res.status(201).json({
                ...
                shortUrl: `https://url-shortener-backend-wwt7.onrender.com/url/${url.shortUrl}`,
            });
            ...
            res.status(201).json({
                ...
                shortUrl: `https://url-shortener-backend-wwt7.onrender.com/url/${isOriginalUrl.shortUrl}`,
            });
